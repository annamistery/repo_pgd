    ...
    def main_pair(self):
        ...
        return {
            "Основная чашка": {
                ...
                "Внутренняя личность. Внутренний мир мужчины и его вклад в отношения.": point_N,
                "Соединение внутреннего и внешнего мира для женщины в данных отношениях. Урок.": point_O,
