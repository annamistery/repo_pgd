...
class PGD_Person_Mod:
    ...
    def calculate_points(self):
        ...
        return {"Основная чашка":
            ...
            "Как проявляется профессионализм – для женской диагностики. Ожидания в совместной жизни, чего вы хотите от партнёрши или как Вы будете себя с ней вести – для мужской диагностики": point_L,
