...
with st.form("personal_form"):
    name = st.text_input("Имя", "Анастасия")
    date = st.text_input("Дата рождения (ДД.ММ.ГГГГ)", "09.10.1988")
...
with st.form("pair_form"):
    name1 = st.text_input("Имя первого человека", "Ирина")
    date1 = st.text_input("Дата рождения первого (ДД.ММ.ГГГГ)", "10.02.1978")
    name2 = st.text_input("Имя второго человека", "Григорий")
    date2 = st.text_input("Дата рождения второго (ДД.ММ.ГГГГ)", "23.01.1974")
